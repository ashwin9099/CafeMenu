            ...
            try
            {
                if (checkBox23.Checked)
                {
                    ...
                    string query = "INSERT INTO menudata (item,price,qty,total) values (" +
                        "'" + checkBox23.Text + "', '60','" + numericUpDown22.Text + "',60*" + numericUpDown22.Text + ")";
                ...
                if (checkBox22.Checked)
                {
                    ...
                    string query = "INSERT INTO menudata (item,price,qty,total) values (" +
                        "'" + checkBox22.Text + "', '70','" + numericUpDown23.Text + "',70*" + numericUpDown23.Text + ")";
                    SqlCommand cmd = new SqlCommand(query, con);
                    try
                    {
                        con.Open();
                ...
                if (checkBox21.Checked)
                {
                    ...
                    string query = "INSERT INTO menudata (item,price,qty,total) values (" +
                        "'" + checkBox21.Text + "', '80','" + numericUpDown19.Text + "',80*" + numericUpDown19.Text + ")";
                    SqlCommand cmd = new SqlCommand(query, con);
                    try
                    {
                        con.Open();
                ...
                if (checkBox19.Checked)
                {
                    ...
                    string query = "INSERT INTO menudata (item,price,qty,total) values (" +
                         "'" + checkBox19.Text + "', '80','" + numericUpDown18.Text + "',80*" + numericUpDown18.Text + ")";
                    SqlCommand cmd = new SqlCommand(query, con);
                    try
                    {
                        con.Open();
                ...
                if (checkBox20.Checked)
                {
                    ...
                    string query = "INSERT INTO menudata (item,price,qty,total) values (" +
                         "'" + checkBox20.Text + "', '60','" + numericUpDown17.Text + "',60*" + numericUpDown17.Text + ")";
                    SqlCommand cmd = new SqlCommand(query, con);
                    try
                    {
                        con.Open();
                ...
                if (checkBox17.Checked)
                {
                    ...
                    string query = "INSERT INTO menudata (item,price,qty,total) values (" +
                         "'" + checkBox17.Text + "', '70','" + numericUpDown16.Text + "',70*" + numericUpDown16.Text + ")";
                    SqlCommand cmd = new SqlCommand(query, con);
                    try
                    {
                        con.Open();
                ...
                if (checkBox18.Checked)
                {
                    ...
                    string query = "INSERT INTO menudata (item,price,qty,total) values (" +
                        "'" + checkBox18.Text + "', '60','" + numericUpDown20.Text + "',60*" + numericUpDown20.Text + ")";
                ...
                if (checkBox16.Checked)
                {
                    ...
                    string query = "INSERT INTO menudata (item,price,qty,total) values (" +
                        "'" + checkBox16.Text + "', '140','" + numericUpDown23.Text + "',140*" + numericUpDown23.Text + ")";
